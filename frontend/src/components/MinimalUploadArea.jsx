...
const MinimalUploadArea = ({ onUpload, isUploading, hasActiveTask, recentTranscription, onDownload }) => {
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="minimal-button text-gray-700 hover:bg-gray-100 border border-gray-300"
              >
